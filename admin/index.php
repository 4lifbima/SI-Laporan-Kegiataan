...
<head>
	...
	<!--favicon-->
	<link rel="icon" href="../assets/images/poldagorontalo.png" type="image/png" />
	<!--plugins-->
	...
	<div class="wrapper">
		...
		<div class="sidebar-wrapper" data-simplebar="true">
			<div class="sidebar-header">
				<div>
					<img src="../assets/images/poldagorontalo.png" width="40px" height="50px" alt="logo icon">
				</div>
				<div>
					<h4 class="logo-text">Polda Gorontalo</h4>
				</div>
		...
		<footer class="page-footer">
			<p class="mb-0">Copyright © 2024. Polda Gorontalo <br> Developer By <a href='https://4lifbima.github.io' title='ALIF BIMA' target='_blank'>Alif Bima</a>
			</p>
		</footer>
	</div>
	<!--end wrapper-->
